...
class OrchestratorAgent(BFAAgent):
    ...
    async def run(self, user_message: str, context: RequestContext) -> str:
        ...
        planner_prompt = (
            ...
            "Rules:\n"
            "1. If the user wants to write an essay, article, or general text, select 'write article'.\n"
            "2. If the user wants to research or search for something, select 'research topic'.\n"
